...
already processed movies twice.""")
    ...
    showComment("""You can define the first and/or last frame of the simulation.
By default the whole simulation is played.""", 2)
    showAttOpt("firstSimulationStep", "number", 2)
    showAttOpt("lastSimulationStep", "number", 2)
